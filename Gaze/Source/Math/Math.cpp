...
namespace Gaze::Math
{
    ...
    glm::vec3 Scale(const glm::vec3& v, float desiredLength) { return v * desiredLength / length(v); }
    ...
    bool DecomposeTransform(const glm::mat4& transform, glm::vec3& translation, glm::quat& rotation, glm::vec3& scale)
    {
        ...
        GZ_CORE_ASSERT(epsilonEqual(LocalMatrix[3][3], static_cast<T>(1), static_cast<T>(0.00001)));
        // for (length_t i = 0; i < 4; ++i)
        //	for (length_t j = 0; j < 4; ++j)
        //		LocalMatrix[i][j] /= LocalMatrix[3][3];

        // Ignore perspective
        GZ_CORE_ASSERT(epsilonEqual(LocalMatrix[0][3], static_cast<T>(0), epsilon<T>()) &&
        ...
        //	mat<4, 4, T, Q> InversePerspectiveMatrix = glm::inverse(PerspectiveMatrix);//   inverse(PerspectiveMatrix,
        // inversePerspectiveMatrix); 	mat<4, 4, T, Q> TransposedInversePerspectiveMatrix =
        ...
        GZ_CORE_ASSERT(dot(Row[0], Pdum3) >= static_cast<T>(0));
#endif
