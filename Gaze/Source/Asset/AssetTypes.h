#ifndef GAZE_ENGINE_ASSETTYPES_H
#define GAZE_ENGINE_ASSETTYPES_H
...
namespace Gaze
{
    ...
    namespace Utils
    {
        inline AssetType AssetTypeFromString(const std::string& assetType)
        {
            ...
            if (assetType == "AnimationController")
                return AssetType::AnimationController;

            GZ_CORE_ASSERT(false, "Unknown Asset Type");
            return AssetType::None;
        }
...
#endif // GAZE_ENGINE_ASSETTYPES_H
