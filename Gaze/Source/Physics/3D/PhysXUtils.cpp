...
namespace Gaze::PhysXUtils
{
    ...
    CookingResult FromPhysXCookingResult(physx::PxConvexMeshCookingResult::Enum cookingResult)
    {
        switch (cookingResult)
        {
            ...
            case physx::PxConvexMeshCookingResult::eZERO_AREA_TEST_FAILED:
                return CookingResult::ZeroAreaTestFailed;
            case physx::PxConvexMeshCookingResult::ePOLYGONS_LIMIT_REACHED:
                return CookingResult::PolygonLimitReached;
    ...
    CookingResult FromPhysXCookingResult(physx::PxTriangleMeshCookingResult::Enum cookingResult)
    {
        switch (cookingResult)
        {
            ...
            case physx::PxTriangleMeshCookingResult::eLARGE_TRIANGLE:
                return CookingResult::LargeTriangle;
    ...
    const char* CookingResultToString(CookingResult cookingResult)
    {
        switch (cookingResult)
        {
            case Gaze::CookingResult::Success:
                return "Success";
            case Gaze::CookingResult::ZeroAreaTestFailed:
                return "ZeroAreTestFailed";
            case Gaze::CookingResult::PolygonLimitReached:
                return "PolygonLimitReached";
            case Gaze::CookingResult::LargeTriangle:
                return "LargeTriangle";
            case Gaze::CookingResult::InvalidMesh:
                return "InvalidMesh";
            case Gaze::CookingResult::Failure:
                return "Failure";
        }
    ...
    physx::PxBroadPhaseType::Enum ToPhysXBroadphaseType(BroadphaseType type)
    {
        switch (type)
        {
            case Gaze::BroadphaseType::SweepAndPrune:
                return physx::PxBroadPhaseType::eSAP;
            case Gaze::BroadphaseType::MultiBoxPrune:
                return physx::PxBroadPhaseType::eMBP;
            case Gaze::BroadphaseType::AutomaticBoxPrune:
    ...
    physx::PxFrictionType::Enum ToPhysXFrictionType(FrictionType type)
    {
        switch (type)
        {
            case Gaze::FrictionType::Patch:
                return physx::PxFrictionType::ePATCH;
            case Gaze::FrictionType::OneDirectional:
                return physx::PxFrictionType::eONE_DIRECTIONAL;
            case Gaze::FrictionType::TwoDirectional:
