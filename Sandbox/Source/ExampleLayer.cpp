...
//    Gaze::BufferLayout layout = {{Gaze::ShaderDataType::Float3, "a_Position"},
...
//    squareVB->SetLayout({{Gaze::ShaderDataType::Float3, "a_Position"}, {Gaze::ShaderDataType::Float2, "a_TexCoord"}});
...
//
//    m_Texture = Gaze::Texture2D::Create("Assets/Textures/Checkerboard.png");
//
//    m_ChernoLogoTexture = Gaze::Texture2D::Create("Assets/Textures/ChernoLogo.png");
//
//    textureShader->Bind();
...
//};
//
//void ExampleLayer::OnEvent(Gaze::Event& event) { m_CameraController.OnEvent(event); };