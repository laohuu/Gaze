#ifndef GAZE_ENGINE_OPENGLMATERIAL_H
#define GAZE_ENGINE_OPENGLMATERIAL_H
...
namespace Gaze
{
    ...
    public:
        ...
        void Set(const std::string& name, const T& value)
        {
            ...
            GZ_CORE_ASSERT(decl, "Could not find uniform!");
            if (!decl)
                return;
        ...
        {
            auto decl = FindUniformDeclaration(name);
            GZ_CORE_ASSERT(decl, "Could not find uniform with name 'x'");
            auto& buffer = m_UniformStorageBuffer;
        ...
        Ref<T> GetResource(const std::string& name)
        {
            ...
            GZ_CORE_ASSERT(decl, "Could not find uniform with name 'x'");
            uint32_t slot = decl->GetRegister();
            GZ_CORE_ASSERT(slot < m_Textures.size(), "Texture slot is invalid!");
...
#endif // GAZE_ENGINE_OPENGLMATERIAL_H
