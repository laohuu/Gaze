...
#define GZ_ADD_INTERNAL_CALL(Name) mono_add_internal_call("Gaze.InternalCalls::" #Name, Name)
    ...
    void ScriptGlue::RegisterFunctions()
    {
        ...
        GZ_ADD_INTERNAL_CALL(GetScriptInstance);

        GZ_ADD_INTERNAL_CALL(Entity_HasComponent);
        GZ_ADD_INTERNAL_CALL(Entity_FindEntityByName);
        GZ_ADD_INTERNAL_CALL(TransformComponent_GetTranslation);
        GZ_ADD_INTERNAL_CALL(TransformComponent_SetTranslation);

        GZ_ADD_INTERNAL_CALL(Rigidbody2DComponent_ApplyLinearImpulse);
        GZ_ADD_INTERNAL_CALL(Rigidbody2DComponent_ApplyLinearImpulseToCenter);
        GZ_ADD_INTERNAL_CALL(Rigidbody2DComponent_GetLinearVelocity);
        GZ_ADD_INTERNAL_CALL(Rigidbody2DComponent_GetType);
        GZ_ADD_INTERNAL_CALL(Rigidbody2DComponent_SetType);

        GZ_ADD_INTERNAL_CALL(Input_IsKeyDown);
    }
