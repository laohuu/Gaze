...
namespace Gaze
{
    ...
    struct Renderer2DData
    {
        ...
        Gaze::Ref<VertexArray>  LineVertexArray;
        Gaze::Ref<VertexBuffer> LineVertexBuffer;
        Gaze::Ref<Shader>       LineShader;
    ...
    void Renderer2D::Init()
    {
        ...
        s_Data.QuadVertexBuffer = Gaze::VertexBuffer::Create(s_Data.MaxVertices * sizeof(QuadVertex));
        ...
        Gaze::Ref<IndexBuffer> quadIB = IndexBuffer::Create(quadIndices, s_Data.MaxIndices);
    ...
    void Renderer2D::DrawQuad(const glm::vec2&            position,
                              const glm::vec2&            size,
                              const Gaze::Ref<Texture2D>& texture,
                              float                       tilingFactor,
