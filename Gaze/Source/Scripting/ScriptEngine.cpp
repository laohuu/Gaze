...
namespace Gaze
{
    ...
    static std::unordered_map<std::string, ScriptFieldType> s_ScriptFieldTypeMap = {
        ...
        {"Gaze.Vector2", ScriptFieldType::Vector2},
        {"Gaze.Vector3", ScriptFieldType::Vector3},
        {"Gaze.Vector4", ScriptFieldType::Vector4},

        {"Gaze.Entity", ScriptFieldType::Entity},
    };
    ...
    namespace Utils
    {
        ...
        ScriptFieldType MonoTypeToScriptFieldType(MonoType* monoType)
        {
            ...
            {
                GZ_CORE_ERROR("Unknown type: {}", typeName);
    ...
    void ScriptEngine::InitMono()
    {
        ...
        MonoDomain* rootDomain = mono_jit_init("GazeJITRuntime");
        GZ_CORE_ASSERT(rootDomain);
    ...
    bool ScriptEngine::LoadAssembly(const std::filesystem::path& filepath)
    {
        ...
        s_Data->AppDomain = mono_domain_create_appdomain("GazeScriptRuntime", nullptr);
    ...
    void ScriptEngine::OnUpdateEntity(Entity entity, Timestep ts)
    {
        ...
        {
            GZ_CORE_ERROR("Could not find ScriptInstance for entity {}", entityUUID);
        }
    }
    ...
    void ScriptEngine::LoadAssemblyClasses()
    {
        ...
        int32_t    numTypes    = mono_table_info_get_rows(typeDefinitionsTable);
        MonoClass* entityClass = mono_class_from_name(s_Data->CoreAssemblyImage, "Gaze", "Entity");
        ...
        for (int32_t i = 0; i < numTypes; i++)
        {
            ...
            GZ_CORE_WARN("{} has {} fields:", className, fieldCount);
            ...
            while (MonoClassField* field = mono_class_get_fields(monoClass, &iterator))
            {
                ...
                if (flags & FIELD_ATTRIBUTE_PUBLIC)
                {
                    ...
                    GZ_CORE_WARN("  {} ({})", fieldName, Utils::ScriptFieldTypeToString(fieldType));
